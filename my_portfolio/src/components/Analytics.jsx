    ...
    <div className='w-full bg-white py-10 px-2'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center'>
                ...
                <button className='bg-[#000300] px-2 py-2 mt-6 font-bold sm:text-xl text-md mx-auto md:text-xl text-[#00df9a] w-[200px] rounded-md active:relative top-1'>Get Stated</button>
            </div>
